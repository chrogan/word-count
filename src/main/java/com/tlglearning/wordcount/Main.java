 ...
 * This demonstration used (in the included methods) implementations of the {@link java.util.Map},
...
public final class Main {
  ...
  /**
   * Creates an instance of {@link WordCounter}, using it ot process the contents of "The Hound of
   * the Baskervilles", by Author Conan Doyle. After processing, the word counts (excluding short
